...
import styles from './searchAutosuggest__DEPRECATED.module.scss';
...
const SearchAutosuggest: React.FC<SearchAutosuggestProps> = ({
        ...
        case 'Enter':
          ...
          if (selectedItem) {
            ...
            handleMenuOptionClick({
              text: searchValue,
              type: AUTOSUGGEST_TYPES__DEPRECATED.TEXT,
              value: searchValue,
            });
          }
          break;
  ...
  React.useEffect(() => {
    ...
    const items: AutosuggestMenuOption__DEPRECATED[] = [];
    const textItem = {
      text: internalInputValue,
      type: AUTOSUGGEST_TYPES__DEPRECATED.TEXT,
    ...
    items.push(
      ...(keywordsData?.keywordList.data
        ...
        .map((keyword) => ({
          ...
          type: AUTOSUGGEST_TYPES__DEPRECATED.KEYWORD,
          value: keyword.id || '',
        })) || [])
    );
  ...
  const handleMenuOptionClick = React.useCallback(
    (option: AutosuggestMenuOption__DEPRECATED) => {
