...
it('is visible after mounting', async () => {
  const Component = (
    <VisibleAfterComponentMounted>Hello World</VisibleAfterComponentMounted>
  );
...
it('renders as heading', () => {
  render(
    <VisibleAfterComponentMounted as="h1">
      Hello World
    </VisibleAfterComponentMounted>
  );
  expect(
...
it('renders as button', () => {
  render(
    <VisibleAfterComponentMounted as="button">
      Hello World
    </VisibleAfterComponentMounted>
  );
  expect(
    screen.queryByRole('button', { name: 'Hello World' })
  ).toBeInTheDocument();
});
